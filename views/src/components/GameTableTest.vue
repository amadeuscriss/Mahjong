...
export default {
  ...
  data() {
    return {
      ...
      playerActions: ['Win'], // 玩家操作
      currentTurnPlayerName: '3',
  ...
  mounted() {
    if (this.$ws) {
      ...
      const mockMessages = {"playerActions":["Win","Chi"],"type":"playerActions","tilesToEat":[[6,5,-1]]}
      this.handleMessage(mockMessages)
      // // 依次处理模拟信息
